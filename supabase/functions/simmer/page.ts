...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .gactions { display: flex; justify-content: flex-end; margin-bottom: 8px; }
...
<div id="groceryview" class="gwrap" style="display:none">
  <div class="gactions"><button class="gclear" id="gclear">Clear checked</button></div>
  <div id="glist"></div>
...
(function () {
  ...
  function renderGrocery() {
    ...
    open.concat(done).forEach(function (g) {
