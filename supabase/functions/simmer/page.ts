...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .ing { display: flex; align-items: flex-start; gap: 11px; padding: 11px 0;
    border-bottom: 1px solid var(--line); font-size: 15px; }
  .ing:last-child { border-bottom: none; padding-bottom: 0; }
  .ing input { -webkit-appearance: none; appearance: none; width: 21px; height: 21px; flex: 0 0 21px;
    border-radius: 7px; border: 1.5px solid var(--line-2); background: transparent; margin: 1px 0 0;
  ...
  .cartbtn { border: none; background: var(--sand); color: var(--ink-2); border-radius: 10px;
    width: 30px; height: 30px; font-size: 14px; font-weight: 700; flex: 0 0 30px; line-height: 1;
    display: inline-flex; align-items: center; justify-content: center;
    transition: transform var(--t-1) var(--e-out), background-color var(--t-2), color var(--t-2); }
